...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<c:choose>
					<c:when test="<#noparse>${</#noparse>defId==0}">
	...
	<div class="panel-body">
		<form id="${classVar}Form" method="post" action="save.ht">
			...
			<input type="hidden" id="${pkVar}" name="${pkVar}" value="<#noparse>${</#noparse>${classVar}.${pkVar}<#noparse>}</#noparse>" />	
			<input type="hidden" id="defId" value="<#noparse>${</#noparse>defId}" />				
		</form>
	</div>
</div>
</body>
